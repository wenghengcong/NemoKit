...
//  NMCore
//
//  Created by Hunt on 2020/9/16.
//

#import "NSObject+Nemo.h"
#import "NMCoreMacro.h"
#import <objc/objc.h>
#import <objc/runtime.h>

NMSYNTH_DUMMY_CLASS(NSObject_Nemo)

@implementation NSObject (Nemo)
...
#define case_size(_size_) \
    ...
    [inv setArgument:&arg atIndex:index]; \
            ...
            case_size(61) case_size(62) case_size(63) case_size(64)
                ...
                NSLog(@"NemoKit performSelectorWithArgs unsupported type:%s (%lu bytes)",
...
/// 方法交换
/// 可以参考一篇文章：https://juejin.im/entry/6844903517979672590
/// @param originalSel <#originalSel description#>
