...
@implementation UITabBarItem (NMUI)

NMBFSynthesizeIdCopyProperty(nmui_doubleTapBlock, setNmui_doubleTapBlock)

- (UIImageView *)nmui_imageView {
    return [self.class nmui_imageViewInTabBarButton:self.nmui_view];
}

+ (UIImageView *)nmui_imageViewInTabBarButton:(UIView *)tabBarButton {
