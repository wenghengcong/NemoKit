...
@interface UIButton (NMUI)


typedef NS_ENUM(NSUInteger, NMUICustomizeButtonPropType) {
    NMUICustomizeButtonPropTypeTitle,
    NMUICustomizeButtonPropTypeTitleColor,
    NMUICustomizeButtonPropTypeTitleShadowColor,
    NMUICustomizeButtonPropTypeImage,
    NMUICustomizeButtonPropTypeBackgroundImage,
    NMUICustomizeButtonPropTypeAttributedTitle
};
 ...
 * @note 该方法会对设置了任何 NMUICustomizeButtonPropType 都返回 YES
 */
- (BOOL)nmui_hasCustomizedButtonPropForState:(UIControlState)state;

/**
 * 判断该 button 在特定 UIControlState 下是否设置了某个 NMUICustomizeButtonPropType 属性
