...
@implementation UITextView (NMUI)
...
- (UITextRange *)nmui_convertUITextRangeFromNSRange:(NSRange)range {
...
- (void)nmui_scrollRangeToVisible:(NSRange)range {
    ...
    UITextRange *textRange = [self nmui_convertUITextRangeFromNSRange:range];
    if (!textRange) return;
