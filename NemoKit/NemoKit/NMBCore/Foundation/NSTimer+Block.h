 ...
 */
+ (NSTimer *)nm_scheduledTimerWithTimeInterval:(NSTimeInterval)seconds
...
/**
 ...
 @return A new NSTimer object, configured according to the specified parameters.
 */
+ (NSTimer *)nm_timerWithTimeInterval:(NSTimeInterval)seconds
                             block:(void (^)(NSTimer *timer))block repeats:(BOOL)repeats;
