...
@interface NMUIHelper (Interface)
 ...
 *  @see [NMUIConfiguration automaticallyRotateDeviceOrientation]
 */
 ...
 *  @see [NMUIHelper rotateToDeviceOrientation]
 */
