...
#ifndef NMBFoundationMacro_h
#define NMBFoundationMacro_h
...
#define BeginIgnoreUIKVCAccessProhibited if (@available(iOS 13.0, *)) NSThread.currentThread.nmbf_shouldIgnoreUIKVCAccessProhibited = YES;
#define EndIgnoreUIKVCAccessProhibited if (@available(iOS 13.0, *)) NSThread.currentThread.nmbf_shouldIgnoreUIKVCAccessProhibited = NO;
...
setterWithGetter(SEL getter) {
    ...
    [setterString appendString:getterString.nmbf_capitalizedString];
