 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `NMModel` protocol for custom methods.
 ...
 Sample Code:
     ...
     ********************** json convertor *********************
 @code
     @interface NMAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation NMAuthor
     @end
 
     @interface NMBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) NMAuthor *author;
     @end
     ...
     int main() {
         ...
         NMBook *book = [NMBook modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 ...
 @code
     @interface NMShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation NMShadow
 ...
 */
@interface NSDictionary (NMModel)
...
/**
 ...
 There's no need to add '<NMModel>' to your class header.
 */
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
  @code
        @class NMShadow, NMBorder, NMAttachment;
        ...
        @implementation NMAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [NMShadow class],
                     @"borders" : NMBorder.class,
...
/**
 ...
 Example:
 @code
        @class NMCircle, NMRectangle, NMLine;
 
        @implementation NMShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [NMCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [NMRectangle class];
