...
typedef NS_ENUM(NSUInteger, NMDateComponent){
    NMDateComponentEra,
    NMDateComponentYear,
    NMDateComponentMonth,
    NMDateComponentDay,
    NMDateComponentHour,
    NMDateComponentMinute,
    NMDateComponentSecond,
    NMDateComponentWeekday,
    NMDateComponentWeekdayOrdinal,
    NMDateComponentQuarter,
    NMDateComponentWeekOfMonth,
    NMDateComponentWeekOfYear,
    NMDateComponentYearForWeekOfYear,
    NMDateComponentDayOfYear
};
...
@implementation NSDate (NMDateTools)
 ...
 */
- (NSInteger)era{
    return [self componentForDate:self type:NMDateComponentEra calendar:nil];
}
 ...
 */
- (NSInteger)year{
    return [self componentForDate:self type:NMDateComponentYear calendar:nil];
}
 ...
 */
- (NSInteger)month{
    return [self componentForDate:self type:NMDateComponentMonth calendar:nil];
}
 ...
 */
- (NSInteger)day{
    return [self componentForDate:self type:NMDateComponentDay calendar:nil];
}
 ...
 */
- (NSInteger)hour{
    return [self componentForDate:self type:NMDateComponentHour calendar:nil];
}
 ...
 */
- (NSInteger)minute{
    return [self componentForDate:self type:NMDateComponentMinute calendar:nil];
}
 ...
 */
- (NSInteger)second{
    return [self componentForDate:self type:NMDateComponentSecond calendar:nil];
}
 ...
 */
- (NSInteger)weekday{
    return [self componentForDate:self type:NMDateComponentWeekday calendar:nil];
}
...
- (NSInteger)weekdayOrdinal{
    return [self componentForDate:self type:NMDateComponentWeekdayOrdinal calendar:nil];
}
 ...
 */
- (NSInteger)quarter{
    return [self componentForDate:self type:NMDateComponentQuarter calendar:nil];
}
...
- (NSInteger)weekOfMonth{
    return [self componentForDate:self type:NMDateComponentWeekOfMonth calendar:nil];
}
...
- (NSInteger)weekOfYear{
    return [self componentForDate:self type:NMDateComponentWeekOfYear calendar:nil];
}
...
- (NSInteger)yearForWeekOfYear{
    return [self componentForDate:self type:NMDateComponentYearForWeekOfYear calendar:nil];
}
 ...
 */
- (NSInteger)dayOfYear{
    return [self componentForDate:self type:NMDateComponentDayOfYear calendar:nil];
}
...
- (NSInteger)eraWithCalendar:(NSCalendar *)calendar{
    return [self componentForDate:self type:NMDateComponentEra calendar:calendar];
}
...
- (NSInteger)yearWithCalendar:(NSCalendar *)calendar{
    return [self componentForDate:self type:NMDateComponentYear calendar:calendar];
}
...
- (NSInteger)monthWithCalendar:(NSCalendar *)calendar{
    return [self componentForDate:self type:NMDateComponentMonth calendar:calendar];
}
...
- (NSInteger)dayWithCalendar:(NSCalendar *)calendar{
    return [self componentForDate:self type:NMDateComponentDay calendar:calendar];
}
...
- (NSInteger)hourWithCalendar:(NSCalendar *)calendar{
    return [self componentForDate:self type:NMDateComponentHour calendar:calendar];
}
...
- (NSInteger)minuteWithCalendar:(NSCalendar *)calendar{
    return [self componentForDate:self type:NMDateComponentMinute calendar:calendar];
}
...
- (NSInteger)secondWithCalendar:(NSCalendar *)calendar{
    return [self componentForDate:self type:NMDateComponentSecond calendar:calendar];
}
...
- (NSInteger)weekdayWithCalendar:(NSCalendar *)calendar{
    return [self componentForDate:self type:NMDateComponentWeekday calendar:calendar];
}
...
- (NSInteger)weekdayOrdinalWithCalendar:(NSCalendar *)calendar{
    return [self componentForDate:self type:NMDateComponentWeekdayOrdinal calendar:calendar];
}
...
- (NSInteger)quarterWithCalendar:(NSCalendar *)calendar{
    return [self componentForDate:self type:NMDateComponentQuarter calendar:calendar];
}
...
- (NSInteger)weekOfMonthWithCalendar:(NSCalendar *)calendar{
    return [self componentForDate:self type:NMDateComponentWeekOfMonth calendar:calendar];
}
...
- (NSInteger)weekOfYearWithCalendar:(NSCalendar *)calendar{
    return [self componentForDate:self type:NMDateComponentWeekOfYear calendar:calendar];
}
...
- (NSInteger)yearForWeekOfYearWithCalendar:(NSCalendar *)calendar{
    return [self componentForDate:self type:NMDateComponentYearForWeekOfYear calendar:calendar];
}
...
- (NSInteger)dayOfYearWithCalendar:(NSCalendar *)calendar{
    return [self componentForDate:self type:NMDateComponentDayOfYear calendar:calendar];
}
 ...
 *  @param component NMDateComponent - The desired component (i.e. year, day, week, etc)
 *  @param calendar  NSCalendar - The calendar to be used in the processing (Defaults to Gregorian)
 *
 *  @return NSInteger
 */
-(NSInteger)componentForDate:(NSDate *)date type:(NMDateComponent)component calendar:(NSCalendar *)calendar{
    if (!calendar) {
    ...
    if (component == NMDateComponentYearForWeekOfYear) {
    ...
    switch (component) {
        case NMDateComponentEra:
            return [dateComponents era];
        case NMDateComponentYear:
            return [dateComponents year];
        case NMDateComponentMonth:
            return [dateComponents month];
        case NMDateComponentDay:
            return [dateComponents day];
        case NMDateComponentHour:
            return [dateComponents hour];
        case NMDateComponentMinute:
            return [dateComponents minute];
        case NMDateComponentSecond:
            return [dateComponents second];
        case NMDateComponentWeekday:
            return [dateComponents weekday];
        case NMDateComponentWeekdayOrdinal:
            return [dateComponents weekdayOrdinal];
        case NMDateComponentQuarter:
            return [dateComponents quarter];
        case NMDateComponentWeekOfMonth:
            return [dateComponents weekOfMonth];
        case NMDateComponentWeekOfYear:
            return [dateComponents weekOfYear];
        case NMDateComponentYearForWeekOfYear:
            return [dateComponents yearForWeekOfYear];
        case NMDateComponentDayOfYear:
...
-(double)hoursFrom:(NSDate *)date{
    return ([self timeIntervalSinceDate:date])/NM_SECONDS_IN_HOUR;
}
...
-(double)minutesFrom:(NSDate *)date{
    return ([self timeIntervalSinceDate:date])/NM_SECONDS_IN_MINUTE;
}
