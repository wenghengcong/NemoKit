//
//  NMUIImagePickerCollectionViewCell.h
//  Nemo
//
 ...
 */
@interface NMUIImagePickerCollectionViewCell : UICollectionViewCell
...
@property(nonatomic, strong, readonly) NMUIButton *checkboxButton;
...
@property(nonatomic, assign) NMUIAssetDownloadStatus downloadStatus; // Cell 中对应资源的下载状态，这个值的变动会相应地调整 UI 表现
@property(nonatomic, copy) NSString *assetIdentifier;// 当前这个 cell 正在展示的 NMUIAsset 的 identifier
