//
//  NMUINavigationBarScrollingAnimator.h
//  Nemo
//
 ...
 */
@interface NMUINavigationBarScrollingAnimator : NMUIScrollAnimator
 ...
 */
@property(nullable, nonatomic, copy) void (^animationBlock)(NMUINavigationBarScrollingAnimator * _Nonnull animator, float progress);
...
/**
 ...
 @param progress 当前滚动位置处于 offsetYToStartAnimation 到 (offsetYToStartAnimation + distanceToStopAnimation) 之间的哪个进度
 */
@property(nullable, nonatomic, copy) UIImage * (^backgroundImageBlock)(NMUINavigationBarScrollingAnimator * _Nonnull animator, float progress);
...
/**
 ...
 @param progress 当前滚动位置处于 offsetYToStartAnimation 到 (offsetYToStartAnimation + distanceToStopAnimation) 之间的哪个进度
 */
@property(nullable, nonatomic, copy) UIImage * (^shadowImageBlock)(NMUINavigationBarScrollingAnimator * _Nonnull animator, float progress);
...
/**
 ...
 @param progress 当前滚动位置处于 offsetYToStartAnimation 到 (offsetYToStartAnimation + distanceToStopAnimation) 之间的哪个进度
 */
@property(nullable, nonatomic, copy) UIColor * (^tintColorBlock)(NMUINavigationBarScrollingAnimator * _Nonnull animator, float progress);
...
/**
 ...
 @param progress 当前滚动位置处于 offsetYToStartAnimation 到 (offsetYToStartAnimation + distanceToStopAnimation) 之间的哪个进度
 */
@property(nullable, nonatomic, copy) UIColor * (^titleViewTintColorBlock)(NMUINavigationBarScrollingAnimator * _Nonnull animator, float progress);
 ...
 */
@property(nullable, nonatomic, copy) UIStatusBarStyle (^statusbarStyleBlock)(NMUINavigationBarScrollingAnimator * _Nonnull animator, float progress);
...
/**
 ...
 @param progress 当前滚动位置处于 offsetYToStartAnimation 到 (offsetYToStartAnimation + distanceToStopAnimation) 之间的哪个进度
 */
@property(nonatomic, copy) UIColor * (^barTintColorBlock)(NMUINavigationBarScrollingAnimator * _Nonnull animator, float progress);
@end
