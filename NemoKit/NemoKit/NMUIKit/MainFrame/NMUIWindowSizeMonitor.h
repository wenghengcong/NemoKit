...
@protocol NMUIWindowSizeMonitorProtocol <NSObject>
...
@interface UIResponder (NMUIWindowSizeMonitor) <NMUIWindowSizeMonitorProtocol>

@end

typedef void (^NMUIWindowSizeObserverHandler)(CGSize newWindowSize);

@interface NSObject (NMUIWindowSizeMonitor)
