...
@interface NMUINavigationController : UINavigationController
/**
...
/// 增加UIViewController 声明周期的hook方法
@interface NMUINavigationController (UISubclassingHooks)
...
/// 与 NMUINavigationController push/pop 相关的一些方法
@protocol NMUINavigationControllerTransitionDelegate <NSObject>
...
/// 与 NMUINavigationController 外观样式相关的方法
@protocol NMUINavigationControllerAppearanceDelegate <NSObject>
...
/// 与 NMUINavigationController 控制 navigationBar 显隐/动画相关的方法
@protocol NMUICustomNavigationBarTransitionDelegate <NSObject>
...
/**
 *  配合 NMUINavigationController 使用，当 navController 里的 UIViewController 实现了这个协议时，则可得到协议里各个方法的功能。
 *  NMUICommonViewController、NMUICommonTableViewController 默认实现了这个协议，所以子类无需再手动实现一遍。
 */
@protocol NMUINavigationControllerDelegate <UINavigationControllerDelegate, NMUINavigationControllerTransitionDelegate, NMUINavigationControllerAppearanceDelegate, NMUICustomNavigationBarTransitionDelegate>
