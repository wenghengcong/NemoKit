...
@protocol NMNEmptyDataSetSource;
@protocol NMNEmptyDataSetDelegate;

#define NMNEmptyDataSetDeprecated(instead) DEPRECATED_MSG_ATTRIBUTE(" Use " # instead " instead")

/**
 A drop-in UITableView/UICollectionView superclass category for showing empty datasets whenever the view has no content to display.
 @discussion It will work automatically, by just conforming to NMNEmptyDataSetSource, and returning the data you want to show.
 */
@interface UIScrollView (EmptyDataSet)

/** The empty datasets data source. */
@property (nonatomic, weak) IBOutlet id <NMNEmptyDataSetSource> emptyDataSetSource;
/** The empty datasets delegate. */
@property (nonatomic, weak) IBOutlet id <NMNEmptyDataSetDelegate> emptyDataSetDelegate;
...
/**
 ...
 @discussion The data source must adopt the NMNEmptyDataSetSource protocol. The data source is not retained. All data source methods are optional.
 */
@protocol NMNEmptyDataSetSource <NSObject>
@optional
 ...
 */
- (CGPoint)offsetForEmptyDataSet:(UIScrollView *)scrollView NMNEmptyDataSetDeprecated(-verticalOffsetForEmptyDataSet:);
...
/**
 ...
 @discussion The delegate can adopt the NMNEmptyDataSetDelegate protocol. The delegate is not retained. All delegate methods are optional.
 
 @discussion All delegate methods are optional. Use this delegate for receiving action callbacks.
 */
@protocol NMNEmptyDataSetDelegate <NSObject>
@optional
 ...
 */
- (void)emptyDataSetDidTapView:(UIScrollView *)scrollView NMNEmptyDataSetDeprecated(-emptyDataSet:didTapView:);
...
/**
 ...
 @param scrollView A scrollView subclass informing the delegate.
 */
- (void)emptyDataSetDidTapButton:(UIScrollView *)scrollView NMNEmptyDataSetDeprecated(-emptyDataSet:didTapButton:);
...
#undef NMNEmptyDataSetDeprecated
