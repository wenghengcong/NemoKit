...
@protocol NMUITextFieldDelegate <UITextFieldDelegate>
 ...
 */
- (void)textField:(NMUITextField *)textField didPreventTextChangeInRange:(NSRange)range replacementString:(NSString *)replacementString;
 ...
 */
@interface NMUITextField : UITextField

@property(nonatomic, weak) id<NMUITextFieldDelegate> delegate;
