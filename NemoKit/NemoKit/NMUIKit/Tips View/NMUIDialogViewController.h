 ...
 * 弹窗继承自`NMUICommonViewController`，因此可直接使用self.titleView的功能来实现双行标题，具体请查看`NMUINavigationTitleView`。
 * `NMUIDialogViewController`支持以类似`UIAppearance`的方式来统一设置全局的dialog样式，例如`[NMUIDialogViewController appearance].headerViewHeight = 48;`。
 *
 * @see NMUIDialogSelectionViewController
 * @see NMUIDialogTextFieldViewController
 */
@interface NMUIDialogViewController : NMUICommonViewController<NMUIModalPresentationContentViewControllerProtocol, NMUIModalPresentationComponentProtocol>
...
@property(nullable, nonatomic, strong, readonly) NMUIButton *cancelButton;
@property(nullable, nonatomic, strong, readonly) NMUIButton *submitButton;
 ...
 */
- (void)addCancelButtonWithText:(NSString *)buttonText block:(void (^ _Nullable)(__kindof NMUIDialogViewController *aDialogViewController))block;
 ...
 */
- (void)addSubmitButtonWithText:(NSString *)buttonText block:(void (^ _Nullable)(__kindof NMUIDialogViewController *aDialogViewController))block;
 ...
 */
@property(nullable, nonatomic, strong) NMUIModalPresentationViewController *modalPresentationViewController;
...
@interface NMUIDialogViewController (UIAppearance)

+ (instancetype)appearance;
@end

/// 表示没有选中的item
extern const NSInteger NMUIDialogSelectionViewControllerSelectedItemIndexNone;
 ...
 */
@interface NMUIDialogSelectionViewController : NMUIDialogViewController<NMUITableViewDelegate, NMUITableViewDataSource>
...
@property(nullable, nonatomic, strong, readonly) NMUITableView *tableView;

@property(nullable, nonatomic, copy) NSArray <NSString *> *items;

/// 表示单选模式下已选中的item序号，默认为NMUIDialogSelectionViewControllerSelectedItemIndexNone。此属性与 `selectedItemIndexes` 互斥。
...
@property(nullable, nonatomic, copy) void (^cellForItemBlock)(__kindof NMUIDialogSelectionViewController *aDialogViewController, __kindof NMUITableViewCell *cell, NSUInteger itemIndex);
@property(nullable, nonatomic, copy) CGFloat (^heightForItemBlock)(__kindof NMUIDialogSelectionViewController *aDialogViewController, NSUInteger itemIndex);
@property(nullable, nonatomic, copy) BOOL (^canSelectItemBlock)(__kindof NMUIDialogSelectionViewController *aDialogViewController, NSUInteger itemIndex);
@property(nullable, nonatomic, copy) void (^didSelectItemBlock)(__kindof NMUIDialogSelectionViewController *aDialogViewController, NSUInteger itemIndex);
@property(nullable, nonatomic, copy) void (^didDeselectItemBlock)(__kindof NMUIDialogSelectionViewController *aDialogViewController, NSUInteger itemIndex);
 ...
 */
@interface NMUIDialogTextFieldViewController : NMUIDialogViewController
...
- (void)addTextFieldWithTitle:(nullable NSString *)textFieldTitle configurationHandler:(void (^ _Nullable)(NMUILabel *titleLabel, NMUITextField *textField, CALayer *separatorLayer))configurationHandler;

@property(nullable, nonatomic, copy, readonly) NSArray<NMUILabel *> *textFieldTitleLabels;
...
@property(nullable, nonatomic, copy) BOOL (^shouldEnableSubmitButtonBlock)(__kindof NMUIDialogTextFieldViewController *aDialogViewController);
