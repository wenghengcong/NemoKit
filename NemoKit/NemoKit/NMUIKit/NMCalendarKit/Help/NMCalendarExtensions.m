...
@interface NSCalendar (NMCalendarExtensionsPrivate)

@property (readonly, nonatomic) NSDateComponents *nm_privateComponents;

@end

@implementation NSCalendar (NMCalendarExtensions)
...
- (nullable NSDate *)nm_firstDayOfWeek:(NSDate *)week
{
    ...
    NSDateComponents *components = self.nm_privateComponents;
...
- (nullable NSDate *)nm_middleDayOfWeek:(NSDate *)week
{
    if (!week) return nil;
    NSDateComponents *weekdayComponents = [self components:NSCalendarUnitWeekday fromDate:week];
    NSDateComponents *componentsToSubtract = self.nm_privateComponents;
...
- (NSDateComponents *)nm_privateComponents
{
...
@implementation NSMapTable (NMCalendarExtensions)
...
@implementation NSCache (NMCalendarExtensions)
...
@implementation NSObject (NMCalendarExtensions)
...
- (id)nm_performSelector:(SEL)selector withObjects:(nullable id)firstObject, ...
{
