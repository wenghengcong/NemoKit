...
@interface NMUITableViewCell : UITableViewCell
 ...
 */
@property(nonatomic, assign, readonly) NMUITableViewCellPosition cellPosition;
...
@interface NMUITableViewCell (NMUISubclassingHooks)
