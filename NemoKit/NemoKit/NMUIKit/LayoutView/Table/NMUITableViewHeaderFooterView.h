//
//  NMUITableViewHeaderFooterView.h
//  Nemo
//
...
typedef NS_ENUM(NSUInteger, NMUITableViewHeaderFooterViewType) {
    NMUITableViewHeaderFooterViewTypeUnknow,
    NMUITableViewHeaderFooterViewTypeHeader,
    NMUITableViewHeaderFooterViewTypeFooter
};
 ...
 */
@interface NMUITableViewHeaderFooterView : UITableViewHeaderFooterView

@property(nonatomic, weak) UITableView *parentTableView;
@property(nonatomic, assign) NMUITableViewHeaderFooterViewType type;
...
@interface NMUITableViewHeaderFooterView (UISubclassingHooks)
